...
export default function About() {
  ...
  const toggleSection = (index) => setActiveIndex(activeIndex === index ? index : index);
        ...
        {sections.map((section, index) => (
          <div key={index} className="AccordionItem">
            <button className="AccordionTitle" onClick={() => toggleSection(index)}>
              ...
              <span className={`AccordionIcon ${activeIndex === index ? "open" : ""}`}>
            ...
            <div className={`AccordionContent ${activeIndex === index ? "open" : ""}`}>
